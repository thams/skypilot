...
def _get_replica_resources(replica_record: _ReplicaRecord) -> str:
    ...
    spot_identifier = '[Spot] ' if handle.launched_resources.use_spot else ''
    resources_str = f'{handle.launched_nodes}x {cloud}({spot_identifier}{hardware})'  # pylint: disable=line-too-long
    return resources_str
